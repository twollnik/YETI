...
def load_hbefa_berlin_format_data(**kwargs):
    ...
    paths_to_hot_yeti_format_data = load_hot_data(load_hbefa_hot_berlin_format_data, **kwargs)
    paths_to_cold_yeti_format_data = load_cold_data(load_hbefa_cold_berlin_format_data, **kwargs)
