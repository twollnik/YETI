...
from code.strategy_helpers.helpers import remove_prefix_from_keys, create_output_folder_if_necessary, load_hot_data, \
    load_cold_data
...
def load_copert_berlin_format_data(**kwargs):
    ...
    if "cold_strategy" in kwargs:
        ...
        paths_to_hot_yeti_format_data = load_hot_data(load_copert_hot_berlin_format_data, **kwargs)
        paths_to_cold_yeti_format_data = load_cold_data(load_copert_cold_berlin_format_data, **kwargs)
