...
class TestLoadBerlinFormatDataForCopertStrategy(TestCase):
    ...
    @patch("code.copert_strategy.load_berlin_format_data.load_copert_fixed_speed_berlin_format_data",
           return_value={"some": "return", "value": "for mocking"})
    def test_case_only_hot_with_fixed_speed(self, mocked_copert_hot_load_function):

        actual_return_value = load_copert_berlin_format_data(only_hot=True, fixed_speed=True, hot_test_arg1=1, cold_test_arg2="abc")

        self.assertEqual(actual_return_value, {"some": "return", "value": "for mocking"})
        mocked_copert_hot_load_function.assert_called_once_with(only_hot=True, fixed_speed=True, test_arg1=1, cold_test_arg2="abc")
    ...
    def test_case_hot_and_cold_using_copert_cold_strategy(self, mocked_copert_cold_load_function):
        ...
        actual_return_value = load_copert_berlin_format_data(hot_test_arg1=1, cold_test_arg2="abc")

        self.assertEqual(actual_return_value, {"some": "return", "value": "for mocking"})
        mocked_copert_cold_load_function.assert_called_once_with(hot_test_arg1=1, cold_test_arg2="abc")

    @patch("code.copert_strategy.load_berlin_format_data.load_copert_fixed_speed_berlin_format_data",
           return_value={"return": "value", "for": "fixed speed function"})
    @patch("code.copert_strategy.load_berlin_format_data.load_copert_cold_berlin_format_data",
           return_value={"value": "to return", "from": "cold function"})
    def test_case_hot_and_cold_using_copert_cold_strategy_and_fixed_speeds(
            self, mocked_copert_cold_load_function, mocked_copert_fixed_speed_load_function):

        actual_return_value = load_copert_berlin_format_data(
            fixed_speed=True, hot_test_arg1=1, cold_test_arg2="abc", output_folder="some_folder")

        self.assertEqual(actual_return_value, {"hot_return": "value", "hot_for": "fixed speed function",
                                               "cold_value": "to return", "cold_from": "cold function"})
        mocked_copert_fixed_speed_load_function.assert_called_once_with(
            fixed_speed=True, output_folder='some_folder/yeti_format_data_for_hot_strategy', test_arg1=1)
        mocked_copert_cold_load_function.assert_called_once_with(
            fixed_speed=True, output_folder='some_folder/yeti_format_data_for_cold_strategy', test_arg2='abc')
    ...
    @patch("code.copert_strategy.load_berlin_format_data.load_copert_fixed_speed_berlin_format_data",
           return_value={"return": "value", "for": "fixed speed function"})
    def test_case_hot_and_cold_using_arbitrary_cold_strategy_and_fixed_speeds(self, mocked_fixed_speeds_load_function):
        ...
        mocked_fixed_speeds_load_function.assert_called_once_with(
            test_arg1=1, test_arg2="abc", test_arg3=4, fixed_speed=True,
            output_folder='some_folder/yeti_format_data_for_hot_strategy')

        self.assertEqual(actual_return_value,
                         {"hot_return": "value", "hot_for": "fixed speed function",
                          "cold_strategy": "tests.test_copert_strategy.MockStrategy.MockStrategy",
                          "cold_load_berlin_format_data_function": "tests.test_copert_strategy.mock_load_data_function.mock_load_data_function",
                          "cold_output_folder": "some_folder/yeti_format_data_for_cold_strategy",
                          "cold_test_arg1": 1, "cold_test_arg2": "abc", "cold_fixed_speed": True
                          })
    ...
    def test_case_hot_and_cold_data_is_saved_in_folders_named_hot_and_cold_using_fixed_speeds(self):
        ...
        # use data as requried for CopertHotStrategy and HbefaColdStrategy
        data_for_hot_strategy = {
            "berlin_format_link_data": f"{self.init_path}/../../example/example_berlin_format_data/link_data_with_speed.csv",
            "berlin_format_fleet_composition": f"{self.init_path}/../../example/example_berlin_format_data/fleet_composition.csv",
            "hot_berlin_format_emission_factors": f"{self.init_path}/../../example/example_berlin_format_data/copert_emission_factors.csv",
            "berlin_format_los_speeds": f"{self.init_path}/../../example/example_berlin_format_data/los_speeds.csv",
            "berlin_format_traffic_data": f"{self.init_path}/../../example/example_berlin_format_data/traffic_data.csv",
