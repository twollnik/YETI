...
class TestLinkDataLoader(TestCase):
    ...
    def test_link_data_loader(self) -> None:
        ...
        link_data = LinkDataLoader(
            link_data=pd.read_csv(f"{self.init_path}/test_data/input_data/shape_data.csv")
        ).load_data()

        link_data_with_speed = LinkDataLoader(
            link_data=pd.read_csv(f"{self.init_path}/test_data/input_data/shape_data_with_speed.csv")
        ).load_data()

        link_data_expected = pd.read_csv(f"{self.init_path}/test_data/unified_data/link_data.csv")
        link_data_with_speed_expected = pd.read_csv(f"{self.init_path}/test_data/unified_data/link_data_with_speed.csv")
